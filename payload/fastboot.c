...
void fastboot_register(const char *prefix,
    ...
    ((void (*)(const char *prefix, void (*handle)(const char *arg, void *data, unsigned sz), unsigned char security_enabled))(0x4c42a74c | 1))(prefix, handle, security_enabled);
}

void fastboot_publish(const char *name, const char *value) {
    ((void (*)(const char *name, const char *value))(0x4c42a788 | 1))(name, value);
}
...
struct fastboot_cmd *get_fastboot_cmd_list() {
    ...
    const uint8_t pattern[] = {0x40, 0xE0, 0x66, 0x4C, 0x00};
